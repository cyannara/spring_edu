...
@Controller
public class SpringSocketHandlerJSON extends TextWebSocketHandler implements InitializingBean {
	Logger logger = LoggerFactory.getLogger(SpringSocketHandlerJSON.class);
	private Set<WebSocketSession> sessionSet = new HashSet<WebSocketSession>();

	//@Autowired	//private BoardService boardService;

	public SpringSocketHandlerJSON (){ 
		super();
